...
public class SeamCarver {
    ...
    public int[] findVerticalSeam() {
        ...
        // finding the minimum vertex from the last row(because now distTo has the value for the last row only)
        ...
        // as we have got the minimum value from the last row.so,we have to start from the last and go until first row
